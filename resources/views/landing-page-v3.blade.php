  ...
  <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
      ...
      <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        <div class="pl-4 flex items-center">
            @auth
                @if(auth()->user()->hasRole(config('services.general.user_role'))) 
                    <a class="toggleColour text-white no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="{{ url('/utility') }}">
                ...
                @else
                    <a class="toggleColour text-white no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="{{ url('/admin/utility') }}">
                        <!--Icon from: http://www.potlabicons.com/ -->
                        <!-- <svg class="h-8 fill-current inline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512.005 512.005">
                        <rect fill="#2a2a31" x="16.539" y="425.626" width="479.767" height="50.502" transform="matrix(1,0,0,1,0,0)" />
                        <path
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
          <ul class="list-reset lg:flex justify-end flex-1 items-center">
            ...
            <li class="mr-3">
              <a class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#">Discover</a>
            </li>
          </ul>
          @auth
              <x-settings-link />
    ...
    <div class="pt-24">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
          <p class="uppercase tracking-loose w-full">Seamless payments online</p>
          <h1 class="my-4 text-5xl font-bold leading-tight">
            Utility management and payment via the internet
          </h1>
          <p class="leading-normal text-2xl mb-8">
            Scores of users use
            lipa utilities features
            to manage and pay for their
            utilities online
          </p>
          @auth
          @else
        ...
        <div class="flex flex-wrap">
          <div class="w-5/6 sm:w-1/2 p-6">
            ...
            <p class="text-gray-600 mb-8">
                No more dark
                nights. Easily
                pay for your postpaid 
                bills and buy tokens 
                to ensure your
                environment is 
                always illuminated.
            </p>
          ...
          <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <a href="#" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <p class="text-gray-800 text-base px-6 mb-5">
                Send funds to your various service providers to ensure that you enjoy the comfort of the services and avoid being suspended.
              </p>
            </a>
          </div>
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <a href="#" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <p class="text-gray-800 text-base px-6 mb-5">
                Find all information about your payments and spending habits on household utilities stored neatly and efficiently in our platform.
              </p>
            </a>
          </div>
          <!-- <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <a href="#" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <p class="text-gray-800 text-base px-6 mb-5">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis perferendis incidunt voluptates quasi! Ipsam earum at amet excepturi! A totam, aperiam corporis ipsam quisquam sint iure aliquid quae pariatur distinctio ab officia ullam tempore possimus nesciunt dolores quasi provident blanditiis.
              </p>
            </a>
          </div>
          <!-- <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
    ...
    <section class="container mx-auto text-center py-6 mb-12">
      ...
      <h3 class="my-4 text-3xl leading-tight">
        Access our platform to gain the benefits of easily paying for your utilities!
      </h3>
      @auth
      @else
        <button class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
