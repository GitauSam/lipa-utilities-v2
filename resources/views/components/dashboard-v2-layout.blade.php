...
<body class="font-sans antialiased">
    ...
    <div class="min-h-screen bg-gray-200">
        ...
        <nav id="header" class="fixed w-full z-30 top-0 text-black bg-white ml-4 mr-4">
            <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
                <div class="pl-4 flex items-center">
                    @auth
                    <a class="toggleColour no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="{{ 
            auth()->user()->hasRole(config('services.general.user_role')) ? url('/utility') : url('/admin/utility')
          }}">
                        lipa utilities
                    </a>
                    @else
                    <a class="toggleColour no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="{{ url('/') }}">
                        lipa utilities
                    </a>
                    @endauth
                </div>
        ...
        <!-- Page Content -->
        <main class="h-full relative pt-14">
            <div class="flex items-start justify-between">
                <div class="hidden lg:block my-4 ml-4 shadow-lg relative w-80">
                    <div class="bg-white h-full rounded-2xl py-8">
                        <nav>
                            <div>
